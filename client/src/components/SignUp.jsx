    ...
    return(
        <section id="contact" className="signUp">
            <div class="container-fluid">
                <img src="https://cdn-icons-png.flaticon.com/512/4105/4105448.png" class="contact-img" alt=""/>
                <form>
                    ...
                    <button type="submit" className="btn btn-warning w-100 py-2 signUpbtn" onClick={isClickedSignUp}>Sign in</button>
                        ...
                        <div className="divider d-flex justify-content-around align-items-center my-4">
                            <p className="text-center fw-bold mx-3 mb-0 text-muted" type="button" onClick={changeFormType}>Already have an account</p>
                        </div>
